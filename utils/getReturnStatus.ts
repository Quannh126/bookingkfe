export function getReturnUrlStatus(responseCode: string, locale = "vn") {
    const responseCodeTable: Record<string, Record<string, string>> = {
        "00": {
        ...
        // },
        "02": {
            vn: "Giao dịch đã được cập nhật trạng thái",
            en: "This order has been updated to the payment status",
        },
        "03": {
